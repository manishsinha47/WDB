...
namespace WDB { 
    public partial class Form1 : Form
    {
        ...
        static WebBrowser wb1;
      public  static Action<string> AddOutMsgDel;

        public static WebBrowser Wb1
        {
            set { wb1 = value; }
        }
        ...
        {
            bot = new ChatBot(wb1);
            AddOutMsgDel = new Action<string>(addOutMessage);
        ...
        private void showOutput()
        {
            if (!(string.IsNullOrWhiteSpace(InputTxt.Text))) // Make sure the textbox isnt empty
            {
                ...
                string outtt = bot.getOutput(InputTxt.Text); // getOutput implement with Luis.
